...
import { isSafari } from "@src/browserDetector.jsx";
...
class CustomDropdown extends React.Component {
  ...
  handleClose = event => {
    if (this.anchorEl.contains(event.target) || !open) {
      return;
    }
  ...
  render() {
    ...
    return ( //
      <div className={innerDropDown ? classes.innerManager : classes.manager} onMouseLeave={this.handleMouseLeave} > 
        <div className={buttonText !== undefined ? "" : classes.target}>
          ...
          >
            ...
            {caret&&openedCaret ? (open?openedCaret:caret): null}
          </Button>
        </div>
        <Popper
          open={open}
          ...
          transition
          disablePortal={!isSafari || !isWidthUp("lg", this.props.width)}
            ...
            >
              <Paper className={classes.dropdown}>
                {innerDropDown ? (
                  ...
                  <ClickAwayListener onClickAway={this.handleClose} ref="cacat" mouseEvent="onMouseUp">
                    {dropDownMenu}
                  </ClickAwayListener>
                )}
              </Paper>
...
// } & PropTypes.shape(ButtonProps);

export default withWidth()(withStyles(customDropdownStyle)(CustomDropdown));
